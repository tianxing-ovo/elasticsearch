...
public class HotelServiceImpl extends ServiceImpl<HotelMapper, Hotel> implements HotelService {
    ...
    public PageResult search(SearchRequestBody searchRequestBody) {
        ...
        FunctionScoreQuery functionScoreQuery = FunctionScoreQuery.of(fs -> fs
                .query(boolQuery)
                .functions(f -> f.filter(filterQuery).weight(1000.0))
        ...
        NativeQueryBuilder queryBuilder = NativeQuery.builder()
                ...
                .withPageable(PageRequest.of(searchRequestBody.getPage() - 1, searchRequestBody.getSize()));
    ...
    public Map<String, List<String>> filters(SearchRequestBody searchRequestBody) {
        ...
        NativeQuery query = NativeQuery.builder()
                ...
                .withAggregation("brandAgg", Aggregation.of(a -> a.terms(t -> t.field("brand").size(100))))
                .build();
    ...
    private List<String> extractTerms(ElasticsearchAggregations aggregations, String aggName) {
        co.elastic.clients.elasticsearch._types.aggregations.Aggregate aggregate = Objects.requireNonNull(aggregations.get(aggName))
